...
export default function Home() {
      ...
      .then((response) => {
        if (response.ok) {
          return response.json().then((data) => {
            const afterDelete = [...state.data].filter(
              (todo) => todo._id !== id
            );
      ...
      .then((response) => {
        if (response.ok) {
          return response.json().then((newTodo) => {
            setState((prevState) => ({
              ...prevState,
              data: [...prevState.data, newTodo.data],
            }));
            setNewTodoTitle("");
          });
        }
  ...
  return (
    <div className={styles.container}>
              ...
              <Grid item xs>
                ...
                >
                  ...
                  <TodoList
                    todos={
                      state.data.length
                        ? state.data.filter((todo) => todo.completed == false)
                        : []
                    }
                    handleDelete={handleDelete}
                    handleClick={handleClick}
              ...
              <Grid item xs>
                ...
                >
                  ...
                  <TodoList
                    todos={
                      state.data.length
                        ? state.data.filter((todo) => todo.completed == true)
                        : []
                    }
                    handleDelete={handleDelete}
                    handleClick={handleClick}
      ...
      <footer className={styles.footer}>Powered by Titus Vimal Raj</footer>
    </div>
  );
}
